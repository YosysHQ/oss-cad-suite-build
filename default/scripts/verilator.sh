...
if [ ${ARCH_BASE} != 'darwin' ]; then
    ...
    sed -i 's,CXX = '${CXX}',CXX = clang++,g' ${OUTPUT_DIR}${INSTALL_PREFIX}/share/verilator/include/verilated.mk
    sed -i 's,LINK = '${CXX}',LINK = clang++,g' ${OUTPUT_DIR}${INSTALL_PREFIX}/share/verilator/include/verilated.mk
fi
